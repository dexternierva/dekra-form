...
import { PracticalActivityContext } from "../../containers/GetPracticalActivity";

import axios from "axios";
import Alert from "../Alert";

function PracticalActivitiesSummary () {
    const currentUser = useCurrentUser();
    const practicalActivityID = currentUser.practical_activity;                             
    const { loading, response, error, setPracticalActivityID } = useContext(PracticalActivityContext);
    setPracticalActivityID(practicalActivityID ); 
    ...
    const onSubmit=async (values) => {
        ...
        await axios({
            ...
            .then((res) => {
                setDialog({ state: true, header: "Status: Successful", text:"Practical Activities Successfully UPDATED!" });
            })
            .catch(error => {
    ...
    return (
        <>
            ...
            />
            <Typography variant="h4" gutterBottom align="center">Practical Activities Summary</Typography>
...
export default PracticalActivitiesSummary;