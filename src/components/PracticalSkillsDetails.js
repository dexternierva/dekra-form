...
import PracticalSkillsTemplate from "./PracticalSkillsTemplate";
...
function PracticalSkillsDetails () {
    ...
    return (
        <>
            <div ref={componentRef}>
                <GetUsers>
                    <PDFExport 
                        pageTemplate={PracticalSkillsTemplate}
...
export default PracticalSkillsDetails;